...
const Clients = () => {
  ...
  return <div className="min-h-screen ">
      {/* Hero Section */}
      {/* <Helmet>
        <title>Srinivasa Polypack Clients | Trusted by Pharma & Industrial Leaders</title>
        <meta
          name="description"
          content="Discover Srinivasa Polypack’s trusted clients including pharmaceutical, food processing, and industrial leaders. ISO-certified LDPE packaging solutions with proven reliability."
        />
        <meta
          name="keywords"
          content="Srinivasa Polypack clients, pharma packaging, industrial LDPE bags, food processing packaging, ISO certified packaging India"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Our Valued Clients - Srinivasa Polypack" />
        <meta
          property="og:description"
          content="Trusted by leading pharmaceutical, food, and industrial companies across India for LDPE packaging."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.srinivasapolypack.com/clients" />
        <meta property="og:image" content="/og-clients.jpg" />
